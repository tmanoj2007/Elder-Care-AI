  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 text-white flex flex-col justify-between p-4 sm:p-8 font-sans">
      ...
      <div className="max-w-6xl mx-auto w-full flex items-center justify-between py-4 border-b border-slate-800/80">
        ...
        <div className="flex items-center gap-2 bg-slate-800/60 px-3 py-1.5 rounded-full border border-slate-700/80 text-xs font-semibold text-slate-300">
      ...
      {/* HERO TITLE SECTION */}
      <div className="max-w-4xl mx-auto text-center space-y-4 my-8">
        <span className="inline-flex items-center gap-2 bg-teal-500/10 text-teal-300 border border-teal-500/30 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider">
          ...
          <span>Dual-Role Aging-in-Place Platform</span>
        </span>
        <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white leading-tight">
          Welcome to ElderCare AI
        </h2>
        <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto font-medium">
          Please select your entry role below to access personalized voice companion tools or caregiver monitoring analytics.
        </p>
      </div>

      {/* ROLE SELECTION CARDS */}
      <div className="max-w-5xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 my-4">
        
        {/* CARD 1: ELDERLY USER / SENIOR */}
        <div className="bg-slate-800/80 hover:bg-slate-800/90 rounded-3xl p-6 sm:p-8 border-2 border-teal-500/40 hover:border-teal-400 shadow-xl transition-all space-y-6 flex flex-col justify-between group">
          <div className="space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-teal-500/20 text-teal-400 border border-teal-500/30 flex items-center justify-center font-bold">
              <Heart className="w-8 h-8 stroke-[2.2]" />
            </div>

            <div className="space-y-2">
              <span className="text-xs font-bold text-teal-400 uppercase tracking-widest">Elderly User Path</span>
              <h3 className="text-2xl font-black text-white">Senior Voice Home</h3>
              <p className="text-slate-300 text-sm font-medium leading-relaxed">
                Designed with large, high-contrast text and warm voice prompts. Enjoy friendly companion chats, memory games, morning/evening check-ins, medication checklists, and one-touch SOS support.
              </p>
            </div>

            <div className="space-y-2 pt-2 border-t border-slate-700/60">
              <div className="text-xs font-bold text-slate-400 uppercase">Included Senior Features:</div>
              <ul className="text-xs text-slate-300 space-y-1.5 font-semibold">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-teal-400 shrink-0" />
                  <span>Voice AI companion with warm spoken feedback</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-teal-400 shrink-0" />
                  <span>Morning & Evening daily health & mood check-ins</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-teal-400 shrink-0" />
                  <span>Interactive medication reminder checklist</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-teal-400 shrink-0" />
                  <span>Cognitive memory games & one-click Emergency SOS</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-teal-500 hover:bg-teal-400 text-slate-950 font-black py-4 rounded-2xl text-base shadow-lg shadow-teal-500/20 flex items-center justify-center gap-2 transition-all active:scale-95 group-hover:translate-y-[-2px]"
          >
            <span>Enter as Elderly Senior</span>
            <ArrowRight className="w-5 h-5 stroke-[2.5]" />
          </button>
        </div>

        {/* CARD 2: CAREGIVER / FAMILY PROVIDER */}
        <div className="bg-slate-800/80 hover:bg-slate-800/90 rounded-3xl p-6 sm:p-8 border-2 border-indigo-500/40 hover:border-indigo-400 shadow-xl transition-all space-y-6 flex flex-col justify-between group">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <span className="text-xs font-bold text-indigo-400 uppercase tracking-widest">Caregiver Path</span>
              <h3 className="text-2xl font-black text-white">Caregiver Portal</h3>
              <p className="text-slate-300 text-sm font-medium leading-relaxed">
                Connect directly with your loved one's account via Senior Link ID or QR Code. Monitor medication adherence, cognitive scores, speech cadence metrics, and AI daily health summaries.
              </p>
            </div>

            <div className="space-y-2 pt-2 border-t border-slate-700/60">
              <div className="text-xs font-bold text-slate-400 uppercase">Included Caregiver Features:</div>
              <ul className="text-xs text-slate-300 space-y-1.5 font-semibold">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-indigo-400 shrink-0" />
                  <span>Real-time elder account linking via ID (ELD-88219)</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-indigo-400 shrink-0" />
                  <span>Automated daily AI wellness & mood reports</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-indigo-400 shrink-0" />
                  <span>7-day speech cadence trend charts & cognitive scores</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-indigo-400 shrink-0" />
                  <span>Emergency SOS alert dashboard & notification logs</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-black py-4 rounded-2xl text-base shadow-lg shadow-indigo-600/20 flex items-center justify-center gap-2 transition-all active:scale-95 group-hover:translate-y-[-2px]"
          >
            <span>Enter as Family Caregiver</span>
            <ArrowRight className="w-5 h-5 stroke-[2.5]" />
          </button>
        </div>
