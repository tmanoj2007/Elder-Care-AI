...
export const CaregiverNotificationsModule: React.FC<CaregiverNotificationsModuleProps> = ({
  ...
  return (
    <div id="caregiver-notifications-section" className="bg-white rounded-[24px] border border-slate-200/90 shadow-lg overflow-hidden animate-fade-in space-y-0">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-800 pb-6 relative z-10">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button
              ...
              className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white font-extrabold px-4 py-2.5 rounded-xl text-xs flex items-center gap-2 transition-all shadow-md shadow-emerald-500/20 active:scale-95"
            >
