...
export const CaregiverReportsModule: React.FC<CaregiverReportsModuleProps> = ({
  ...
  return (
    <div id="caregiver-reports-section" className="bg-white rounded-3xl border border-slate-200/90 shadow-md overflow-hidden animate-fade-in">
      
      {/* HEADER BAR WITH TIMEFRAME NAVIGATION */}
      <div className="bg-slate-900 text-white p-6 sm:p-8 space-y-6">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 border-b border-slate-800 pb-6">
          <div className="space-y-1.5">
            <div className="inline-flex items-center gap-2 bg-teal-500/20 text-teal-300 px-3.5 py-1 rounded-full text-xs font-black uppercase tracking-wider border border-teal-500/30">
          ...
          <div className="flex flex-wrap items-center gap-2 bg-slate-800/90 border border-slate-700/80 p-2 rounded-2xl shrink-0">
            <button
              type="button"
