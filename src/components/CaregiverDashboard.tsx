...
export const CaregiverDashboard: React.FC<CaregiverDashboardProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-20 font-sans">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-teal-950 text-white py-8 px-6 sm:px-12 border-b border-slate-800 shadow-md">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-slate-300 text-xs sm:text-sm font-medium flex flex-wrap items-center gap-x-4 gap-y-1">
              <span>Elder ID: <strong className="text-teal-300 font-mono">ELD-88219</strong></span>
              <span>•</span>
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="bg-teal-600 hover:bg-teal-500 disabled:bg-slate-700 text-white font-bold px-5 py-3 rounded-xl shadow-lg flex items-center gap-2 text-xs sm:text-sm transition-all active:scale-95"
            >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 py-8 space-y-8">
        ...
        <div className="bg-slate-900 text-white p-3 rounded-2xl border border-slate-800 shadow-md flex flex-wrap items-center justify-between gap-3 sticky top-4 z-30">
          <div className="flex items-center gap-2 overflow-x-auto py-1 text-xs">
            <a
              href="#caregiver-notifications-section"
              className="px-4 py-2.5 rounded-xl font-black bg-rose-500 text-white hover:bg-rose-400 transition-all shadow-md flex items-center gap-1.5 shrink-0"
            >
