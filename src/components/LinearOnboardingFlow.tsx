...
export const LinearOnboardingFlow: React.FC<LinearOnboardingFlowProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/85 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-slate-900/90 border-2 border-emerald-500/40 rounded-[24px] p-6 sm:p-8 max-w-3xl w-full shadow-2xl space-y-6 text-white my-8 animate-fade-in relative overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4 relative z-10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-[14px] bg-gradient-to-tr from-emerald-500 to-teal-500 text-white flex items-center justify-center font-black shadow-md shadow-emerald-500/20">
          ...
          <button
            type="button"
            onClick={onCancel}
            className="text-slate-400 hover:text-white text-xs font-bold px-3 py-1.5 bg-slate-800 hover:bg-slate-700 rounded-xl transition-all border border-slate-700"
          >
            Cancel
          </button>
        </div>
        ...
        <div className="grid grid-cols-5 gap-1.5 p-1.5 bg-slate-950/80 rounded-[18px] border border-slate-800 text-[11px] font-black text-center relative z-10">
          <div className={`py-2 px-1 rounded-xl transition-all ${currentStep === 1 ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md font-extrabold' : currentStep > 1 ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30' : 'text-slate-400'}`}>
            1. Register
          </div>
          <div className={`py-2 px-1 rounded-xl transition-all ${currentStep === 2 ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md font-extrabold' : currentStep > 2 ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30' : 'text-slate-400'}`}>
            2. Profile
          </div>
          <div className={`py-2 px-1 rounded-xl transition-all ${currentStep === 3 ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md font-extrabold' : currentStep > 3 ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30' : 'text-slate-400'}`}>
            3. Medical
          </div>
          <div className={`py-2 px-1 rounded-xl transition-all ${currentStep === 4 ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md font-extrabold' : currentStep > 4 ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30' : 'text-slate-400'}`}>
            4. Medicines
          </div>
          <div className={`py-2 px-1 rounded-xl transition-all ${currentStep === 5 ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md font-extrabold' : 'text-slate-400'}`}>
            5. Emergency
          </div>
        </div>

        {validationError && (
          <div className="bg-rose-500/20 border border-rose-500/40 text-rose-200 p-3 rounded-xl text-xs font-bold flex items-center gap-2">
              ...
              <div className="space-y-1 sm:col-span-2">
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <button
                    ...
                    className={`p-3.5 rounded-[16px] border text-left flex items-center gap-2.5 transition-all ${
                  ...
                  <button
                    ...
                    className={`p-3.5 rounded-[16px] border text-left flex items-center gap-2.5 transition-all ${
                      selectedRole === 'caregiver'
                        ? 'bg-sky-500/20 border-sky-500 text-sky-300 font-extrabold shadow-md'
                        : 'bg-slate-950/80 border-slate-800 text-slate-300 hover:border-slate-700'
                    }`}
                  >
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950/80 border border-slate-800 rounded-xl pl-9 pr-3 py-2.5 text-xs text-white focus:outline-none focus:border-emerald-500"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-center transition-all ${
                      diabetes ? 'bg-emerald-500/20 border-emerald-500 text-emerald-300 font-black shadow-md' : 'bg-slate-950/80 border-slate-800 text-slate-400 hover:border-slate-700'
                    }`}
                  >
                    Diabetes
                  </button>
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-center transition-all ${
                      bloodPressure ? 'bg-emerald-500/20 border-emerald-500 text-emerald-300 font-black shadow-md' : 'bg-slate-950/80 border-slate-800 text-slate-400 hover:border-slate-700'
                    }`}
                  >
                    Hypertension (BP)
                  </button>
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-center transition-all ${
                      heartDisease ? 'bg-emerald-500/20 border-emerald-500 text-emerald-300 font-black shadow-md' : 'bg-slate-950/80 border-slate-800 text-slate-400 hover:border-slate-700'
                    }`}
                  >
                    Heart Disease
                  </button>
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-center transition-all ${
                      asthma ? 'bg-emerald-500/20 border-emerald-500 text-emerald-300 font-black shadow-md' : 'bg-slate-950/80 border-slate-800 text-slate-400 hover:border-slate-700'
                    }`}
                  >
                    Asthma
                  </button>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {COMMON_DISEASES.map((disease) => (
                    ...
                    >
                      <span>{disease}</span>
                      {selectedDiseases.includes(disease) && <Check className="w-4 h-4 text-emerald-400" />}
                    </button>
                  ))}
                </div>
              </div>
        ...
        {currentStep === 4 && (
          <div className="space-y-4 animate-fade-in relative z-10">
            ...
            <div className="bg-slate-950/80 p-4 rounded-[18px] border border-slate-800 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="w-24 bg-slate-900 border border-slate-800 rounded-xl px-3 py-2 text-white focus:outline-none focus:border-emerald-500 text-center font-bold"
                  />

                  <button
                    type="button"
                    onClick={handleAddMedicineItem}
                    className="flex-1 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white font-extrabold rounded-xl text-xs flex items-center justify-center gap-1 transition-all shadow-md shadow-emerald-500/20"
                  >
        ...
        <div className="flex items-center justify-between border-t border-slate-800 pt-4 relative z-10">
          <button
            ...
            className="bg-slate-800 hover:bg-slate-700 text-slate-300 disabled:opacity-40 px-5 py-3 rounded-2xl text-xs font-bold transition-all flex items-center gap-1.5 border border-slate-700"
          >
          ...
          <button
            ...
            className="bg-gradient-to-r from-emerald-500 via-teal-500 to-sky-500 hover:from-emerald-400 hover:to-sky-400 text-white font-extrabold px-6 py-3 rounded-2xl text-xs shadow-lg shadow-emerald-500/25 flex items-center gap-2 transition-all active:scale-95"
          >
